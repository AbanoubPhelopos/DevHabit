...
namespace DevHabit.Infrastructure.Migrations
{
    ...
    [Migration("20260309202957_AddHabitTags")]
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.Habit", b =>
                {
                    ...
                    b.OwnsOne("DevHabit.Domain.Entities.Target", "Targets", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                            ...
                            b1.Property<string>("Units")
                                ...
                                .HasMaxLength(100)
                                .HasColumnType("character varying(100)")
                                .HasColumnName("targets_units");

                            b1.Property<int>("Value")
                                .HasColumnType("integer")
                                .HasColumnName("targets_value");
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.HabitTag", b =>
                {
                    ...
                    b.HasOne("DevHabit.Domain.Entities.Tag", "Tag")
                        .WithMany()
